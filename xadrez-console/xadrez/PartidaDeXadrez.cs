...
namespace xadrez
{
    class PartidaDeXadrez
    {
        ...
        public void realizaJogada(Posicao origem, Posicao destino)
        {
            ...
            //Verificar qual foi a peça movida
            ...
            //verifica que o adversario do Jogador Atual está em Xeque Mate.
        ...
        /* 
         * Validar que está em Xeque Mate
         */
         public bool testeXequemate(Cor cor)
        {
            ...
            //Varrer para saber se tem alguma peça que tira do Xeque mate
                ...
                for (int i=0; i<tab.linhas; i++)
                {
                    for (int j=0; j<tab.colunas; j++)
                    {
                        if (mat[i, j])
                        {
                            ...
                            desfazMovimento(origem, destino, pecaCapturada);
                            if (!testeXeque) //Testa que existe movimento para sair do Xeque.
                            {
                                return false;
                            }
                        }
